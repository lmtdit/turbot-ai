...
| OpenCode               | turbot-ai                                   | 说明              |
| ---------------------- | ------------------------------------------- | ----------------- |
| `Agent.state()`        | `agent_loader::initialize_builtin_agents()` | 初始化内置 agents |
| `Agent.get(name)`      | `AgentRegistry::get(name)`                  | 获取指定 agent    |
| `Agent.list()`         | `AgentRegistry::list()`                     | 列出所有 agents   |
| `Agent.defaultAgent()` | `AgentRegistry::default_agent()`            | 获取默认 agent    |
| `Agent.generate()`     | `agent_generator::generate()`               | 生成新 agent 配置 |
