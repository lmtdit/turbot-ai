...
| 子计划                             | 文件                                                                     | 包含问题                           | 状态      |
| ---------------------------------- | ------------------------------------------------------------------------ | ---------------------------------- | --------- |
| 4.0.1 Session 持久化与权限系统注入 | [4.0.1-session-and-permission.md](./4.0/4.0.1-session-and-permission.md) | P0-1, P0-2                         | ✅ 已完成 |
| 4.0.2 测试覆盖率修复与补全         | [4.0.2-test-coverage.md](./4.0/4.0.2-test-coverage.md)                   | P0-3, P0-4                         | ✅ 已完成 |
| 4.0.3 Agent 实现与 LLM 接入        | [4.0.3-agent-and-llm.md](./4.0/4.0.3-agent-and-llm.md)                   | P1-6, P1-1, P1-4                   | ✅ 已完成 |
| 4.0.4 ACP 修复与工具扩展           | [4.0.4-acp-and-tools.md](./4.0/4.0.4-acp-and-tools.md)                   | P1-2, P1-3, P1-5, P2-1, P2-2, P2-3 | ✅ 已完成 |

### v4.1 功能扩展

**总览**: [4.1-feature-extension-plan.md](./4.1/4.1-feature-extension-plan.md)

| 子计划                 | 文件                                                       | 包含问题               | 状态      |
| ---------------------- | ---------------------------------------------------------- | ---------------------- | --------- |
| 4.1.1 核心工具补全     | [4.1.1-core-tools.md](./4.1/4.1.1-core-tools.md)           | P0-1, P0-2             | ✅ 已完成 |
| 4.1.2 Agent 系统扩展   | [4.1.2-agent-extension.md](./4.1/4.1.2-agent-extension.md) | P0-3, P1-1             | ✅ 已完成 |
